                ...
                <tbody>
                    <tr class="d-flex align-items-center row bg-secondary-subtle rounded p-2 my-3 col-sm-12">
                        ...
                        <td class="col-8 d-flex flex-column justify-content-start align-items-c bg-secondary-subtle ms-3">
                            ...
                            <p class="m-0">Lisne uši su jedne od najčešćih nametnika na biljkama. Sisanjem im oduzimaju hranjiva, a medna rosa koju luče mami mrave i jednu vrstu gljivica koja potom na listovima stvara crnu čađavost. Osim toga, prijenosnici su i virusnih bolesti. </p>
                        </td>
                    </tr>
                    ...
                    <tr class="d-flex align-items-center row bg-secondary-subtle rounded p-2 my-3 col-sm-12">
                        ...
                        <td class="col-8 d-flex flex-column justify-content-start align-items-c bg-secondary-subtle ms-3">
                            ...
                            <p class="m-0">Nedavne vrlo visoke temperature ubrzale su i rast presadnica. No, trenutačne vremenske prilike nisu dobre za sadnju na otvoreno. Kako usporiti rast presadnica?</p>
                        </td>
                    </tr>
