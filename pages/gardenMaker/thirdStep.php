...
?>
    ...
    <div class="d-flex justify-content-center">
                <div class="w-75">
                    <form name="lightForm" id="lightForm" action="../home.php" method="post">
                        ...
                        <div class="dimensions d-flex flex-column justify-content-between mb-5">
                            <div class="firstPick d-flex flex-column p-1">
                                <span class="ms-2 mb-3">
                                    <input class="m-1 form-check-input place" type="radio" name="light" id="none" required>
                                    <label for="none" class="form-check-label">Uvijek u sjeni, nema direktnog svjetla</label>
                                </span>
                            </div>
                            
                            <div class="secondPick d-flex flex-column p-1">
                                <span class="ms-2 mb-3">
                                    <input class="m-1 form-check-input place" type="radio" name="light" id="some" required>
                            ...
                            <div class="thirdPick d-flex flex-column p-1">
                                <span class="ms-2 mb-3">
                                    <input class="m-1 form-check-input place" type="radio" name="light" id="good" required>
