...
?>
    ...
    <div id="napraviVrt">
              ...
              <div class="d-flex justify-content-center">
                <div class="w-50">
                    <form name="gardenForm" id="gardenForm" action="" method="post">
                        <div class="unosIme my-4">
                            <label for="imevrt" class="form-label">Naziv:</label>
                            <input type="text" id="name" class="form-control" id="imevrt" required>
                        </div>
                        <div class="unosOpis my-3">
                            <label for="opisvrt" class="form-label">Opis:</label>
                            <textarea class="form-control" id="desc" id="opisvrt" rows="3" required></textarea>
                        </div>
                        <div class="unosMjesta d-flex flex-column mb-5">
                            <label class="form-label">Mjesto uzgoja:</label>
                            
                            <span class="m-2">
                                <input class="m-1 form-check-input place" type="radio" name="mjesto" id="balkon" required>
                                <label for="balkon" class="form-check-label">Balkon</label>
                            </span>
                            <span class="m-2">
                                <input class="m-1 form-check-input place" type="radio" name="mjesto" id="dvoriste" required> 
